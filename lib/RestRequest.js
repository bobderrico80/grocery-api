...
class RestRequest {
   ...
   * @param {import('./RestController').RestControllerOptions} [options={}] (Defaults to {}) A
   * reference to the {@link RestController} options.
   */
  ...
  handleError() {
    ...
    if (this.error instanceof NotAuthorizedError) {
      this.status = 401;
